[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-24ddc0f5d75046c5622901739e7c5dd533143b0c8e959d652212380cedb1ea36.svg)](https://classroom.github.com/a/kZN4uCZx)
# Soma Dois Números
...
No `main.py` adicione um código que peça para o usuário digitar dois números em sequencia.
Você deve chamar a função `input` duas vezes para isso.
O programa deve imprimir na tela a soma desses dois números.
